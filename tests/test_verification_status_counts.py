...
class VerificationStatusCountsTests(unittest.TestCase):
    def test_visible_counts_match_request_matrix(self) -> None:
        ...
        self.assertEqual(counts["verified"], 13)
        self.assertEqual(counts["reviewed"], 6)
        ...
        self.assertEqual(counts["area_expected"]["HID descriptors"]["reviewed"], 6)
        self.assertEqual(counts["area_expected"]["HID descriptors"]["verified"], 1)
        ...
        self.assertEqual(counts["area_expected"]["HID report descriptors"]["reviewed"], 0)
        self.assertEqual(counts["area_expected"]["HID report descriptors"]["verified"], 6)
        ...
        self.assertEqual(counts["area_expected"]["HID class requests"]["reviewed"], 0)
        self.assertEqual(counts["area_expected"]["HID class requests"]["verified"], 6)
