# Usage ID Identity Matrix Proposal

> Status: proposal only
> Authority ceiling: usage_tables_matrix_schema_proposal_only

This proposal defines a candidate Usage ID identity matrix while keeping Usage Tables
unimported and without producing a production matrix.

## Matrix Candidate

- matrix_id: `usage_id_identity_matrix`
- future path: `data/hid_usage_id_identity_matrix.yaml`
