...
- Candidate: `docs/evidence/candidates/hid_get_protocol_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/hid_get_protocol_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/hid_get_protocol_accepted.yaml`
