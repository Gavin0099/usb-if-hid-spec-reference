...
- Candidate: `docs/evidence/candidates/hid_bLength_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/hid_bLength_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/hid_bLength_accepted.yaml`
