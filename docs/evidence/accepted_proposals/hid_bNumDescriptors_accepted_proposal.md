...
- Candidate: `docs/evidence/candidates/hid_bNumDescriptors_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/hid_bNumDescriptors_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/hid_bNumDescriptors_accepted.yaml`
