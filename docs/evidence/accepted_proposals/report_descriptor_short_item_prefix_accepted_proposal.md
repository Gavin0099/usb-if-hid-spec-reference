...
- Candidate: `docs/evidence/candidates/report_descriptor_short_item_prefix_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/report_descriptor_short_item_prefix_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/report_descriptor_short_item_prefix_accepted.yaml`
