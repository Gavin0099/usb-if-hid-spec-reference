...
class VerificationStatusCountsTests(unittest.TestCase):
    def test_visible_counts_match_request_matrix(self) -> None:
        ...
        self.assertEqual(counts["verified"], 8)
        self.assertEqual(counts["reviewed"], 11)
        ...
        self.assertEqual(counts["area_expected"]["HID report descriptors"]["reviewed"], 5)
        self.assertEqual(counts["area_expected"]["HID report descriptors"]["verified"], 1)
