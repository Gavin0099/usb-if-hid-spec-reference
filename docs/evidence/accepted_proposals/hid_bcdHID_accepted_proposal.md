...
- Candidate: `docs/evidence/candidates/hid_bcdHID_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/hid_bcdHID_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/hid_bcdHID_accepted.yaml`
