...
- Candidate: `docs/evidence/candidates/hid_bDescriptorType_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/hid_bDescriptorType_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/hid_bDescriptorType_accepted.yaml`
