...
| `usage_tables_matrix_proposals` | PASS | `usage_tables_matrix_schema_proposal_validation_only` | `evidence/validation_receipts/hid_current_gate/usage_tables_matrix_proposals.json` |
