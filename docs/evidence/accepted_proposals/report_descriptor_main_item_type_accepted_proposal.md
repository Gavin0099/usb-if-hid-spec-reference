...
- Candidate: `docs/evidence/candidates/report_descriptor_main_item_type_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/report_descriptor_main_item_type_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/report_descriptor_main_item_type_accepted.yaml`
...
- entry_id: `report_descriptor_main_item_type`
