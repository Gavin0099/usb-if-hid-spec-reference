...
- Candidate: `docs/evidence/candidates/hid_bCountryCode_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/hid_bCountryCode_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/hid_bCountryCode_accepted.yaml`
