...
- Candidate: `docs/evidence/candidates/hid_set_idle_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/hid_set_idle_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/hid_set_idle_accepted.yaml`
