...
- Candidate: `docs/evidence/candidates/hid_bDescriptorType_subordinate_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/hid_bDescriptorType_subordinate_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/hid_bDescriptorType_subordinate_accepted.yaml`
...
- entry_id: `hid_bDescriptorType_subordinate`
