...
- Candidate: `docs/evidence/candidates/hid_wDescriptorLength_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/hid_wDescriptorLength_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/hid_wDescriptorLength_accepted.yaml`
...
- entry_id: `hid_wDescriptorLength`
