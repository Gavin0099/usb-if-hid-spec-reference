...
class VerificationStatusCountsTests(unittest.TestCase):
    def test_visible_counts_match_request_matrix(self) -> None:
        ...
        self.assertEqual(counts["reviewed"], 17)
        ...
        self.assertEqual(counts["area_expected"]["HID class requests"]["reviewed"], 4)
        self.assertEqual(counts["area_expected"]["HID class requests"]["verified"], 2)
