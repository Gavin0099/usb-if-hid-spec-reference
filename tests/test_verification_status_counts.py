...
class VerificationStatusCountsTests(unittest.TestCase):
    def test_visible_counts_match_request_matrix(self) -> None:
        ...
        self.assertEqual(counts["reviewed"], 14)
        ...
        self.assertEqual(counts["area_expected"]["HID class requests"]["reviewed"], 1)
        self.assertEqual(counts["area_expected"]["HID class requests"]["verified"], 5)
