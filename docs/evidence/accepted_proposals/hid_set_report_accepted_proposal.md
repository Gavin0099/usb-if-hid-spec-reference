...
- Candidate: `docs/evidence/candidates/hid_set_report_candidate.yaml`
- Pre-approval report: `docs/evidence/preapproval/hid_set_report_preapproval_checklist.md`
- Future accepted packet path: `docs/evidence/accepted/hid_set_report_accepted.yaml`
