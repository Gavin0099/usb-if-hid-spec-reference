...
- Usage Tables governed entries: 0
- verified uplift count: 0
- ready for Level 3 import approval: true
- remaining gaps: 9
...
|---|---|---|---|---|---:|
| `hid_usage_tables` | `not_imported` | `pending_level3_source_authority_import` | `TBD_LEVEL3_APPROVAL` | `False` | 9 |
