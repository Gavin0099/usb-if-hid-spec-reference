...
The proposal validator checks proposal-only status, future accepted packet path
absence, candidate/pre-approval report bindings, Level 3 placeholder controls,
...
## Accepted Packet Proposal Summary

Accepted packet proposal summaries live at:
...
They aggregate the 19 accepted-packet proposal artifacts into a scan-friendly
